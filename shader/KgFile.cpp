...
namespace karma
{
  ...
  {
    struct Shader ;
    typedef std::map<file::ShaderStage, Shader> ShaderMap ;
    ...
    void KgFile::load( const char* path )
    {
      ...
      ::karma::file::Shader    shader  ;
      ::karma::file::Uniform   uniform ;
      ::karma::file::Attribute attr    ;
      ...
      if( stream )
      {
        ...
        if( magic != ::karma::file::MAGIC ) /*TODO: LOG ERROR HERE */ return ;
        ...
        for( unsigned it = 0; it < sz; it++ )
        {
          ...
          shader.stage = static_cast<::karma::file::ShaderStage>( stage ) ;
          for( unsigned index = 0; index < num_uniforms; index++ )
          {
             ...
             uniform.name    = name                                                      ;
             uniform.type    = static_cast<::karma::file::UniformType>( uniform_type ) ;
